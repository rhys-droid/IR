classdef printing < handle
    properties
        ...
        birdhouse_positions = [-0.2, -1.2; -0.2 -1.6];
        pause_time = 0.001;
        z_offset = 0;
        y_position = 0.2;
        trace_handles = [];
    ...
    methods
        function self = printing(dobot)
            ...
            for i = 1:2
                ...
                translated_vertices = self.translateVertices(vertex_matrix, x_position, y_position, 0.9);
        ...
        function clearTracesAndShowPLY(self, ply_filename, position)
            ...
            trisurf(faceData, vertexData(:, 1) + position(1), vertexData(:, 2) + position(2), vertexData(:, 3) + 0.9, 'FaceColor', 'magenta');
        end
